    ...
    case "gallery": // three plates hung on a wire
      return (
        <svg className="scene" height="100" viewBox="0 0 120 100" width="120">
          ...
          <g
            className="sway-a"
            style={{ transformOrigin: "94px 20px", animationDelay: "-1.1s" }}
          >
      ...
      return (
        <svg className="scene" height="100" viewBox="0 0 120 100" width="120">
          ...
          <g className="turn-slow" style={{ transformOrigin: "60px 52px" }}>
            ...
            <path
              d="M30 52h60M60 22v60"
              opacity=".85"
              stroke={CREAM}
              strokeWidth="2.4"
            />
            <path
              d="M38 33c13 8 31 8 44 0M38 71c13-8 31-8 44 0"
              fill="none"
              opacity=".85"
              stroke={CREAM}
              strokeWidth="2.4"
