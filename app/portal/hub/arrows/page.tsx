...
function V2() {
  return (
    <svg fill="none" height="28" viewBox="0 0 38 34" width="32">
      <path
        d="M6 4 C5 15 10 22 24 26"
        stroke={DEEPRED}
        strokeLinecap="round"
        strokeWidth="2.1"
      />
      <path
        d="M26 27 L16 29 M26 27 L19 21"
        stroke={DEEPRED}
        strokeLinecap="round"
        strokeWidth="2.1"
      />
...
function V3() {
  return (
    <svg fill="none" height="24" viewBox="0 0 32 28" width="27">
      <path
        d="M5 4 C4 12 8 18 19 21"
        stroke={DEEPRED}
        strokeLinecap="round"
        strokeWidth="2"
      />
      <path
        d="M21 22 L13 24 M21 22 L15 17"
        stroke={DEEPRED}
        strokeLinecap="round"
        strokeWidth="2"
      />
...
function V4() {
  return (
    <svg fill="none" height="30" viewBox="0 0 30 36" width="25">
      <path
        d="M8 4 C5 14 6 22 16 28"
        stroke={DEEPRED}
        strokeLinecap="round"
        strokeWidth="2.1"
      />
      <path
        d="M18 29 L9 29 M18 29 L14 21"
        stroke={DEEPRED}
        strokeLinecap="round"
        strokeWidth="2.1"
      />
