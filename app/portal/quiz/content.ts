...
export const SCORES: { fr: Scores; en: Scores } = {
  fr: {
    ...
    perfect: "Dix sur dix. Es-tu mon/ma meilleur.e ami.e ou t'as triché ? Voici ta médaille virtuelle.",
  },
  en: {
    ...
    perfect: "Ten out of ten. Are we besties, or did you cheat? Here's your virtual medal.",
  },
};
